...
contract DeployBase is Script {
    function deploy(address _owner, address _dNft, address _asset, address _oracle, uint256 _fee, address _feeRecipient)
        public
        payable
        returns (Contracts memory)
    {
        ...
        Payments payments = new Payments(vaultManager, IWETH(_asset));
        ...
        return Contracts(vaultManagerLicenser, vaultLicenser, dyad, vaultManager, vault, payments);
    }
}
