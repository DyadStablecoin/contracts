...
contract V2Test is BaseTestV2 {
    ...
    function test_Denominator() public {
        uint256 denominator = contracts.kerosineDenominator.denominator();
    ...
    function test_UpgradeVaultManager() public {
        ...
        Upgrades.upgradeProxy(
            ...
            abi.encodeCall(VaultManagerV2UpgradeMock.initialize, (address(1)))
        );
